...
app = Flask(__name__)
app.secret_key = os.environ.get("RAILRESERVE_SECRET", "dev-secret-change-me-in-production")
...
# and never sent to the frontend (only RAZORPAY_KEY_ID, which is a
# public identifier Razorpay's own docs say is safe client-side).
# ------------------------------------------------------------------
ADMIN_EMAIL = os.environ.get("RAILRESERVE_ADMIN_EMAIL", "admin@gmail.com")
ADMIN_PASSWORD = os.environ.get("RAILRESERVE_ADMIN_PASSWORD", "123456")
